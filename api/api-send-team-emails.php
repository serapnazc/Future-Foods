<?php
                                      ...
                                      <tr>
                                         <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                            <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                               ...
                                               <p style="font-size: 14px; line-height: 140%;">Future Foods Competition başvuru aşamasını takım olarak başarıyla tamamladınız! </p>
                                               <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
                                               <p style="font-size: 14px; line-height: 140%;">Şimdi sizden fonksiyonel bir bar için yeni fikir bekliyoruz! Bu aşamayla ilgili detayları ve size yol gösterecek ipuçlarını aşağıdaki bilgilendirme dokümanında bulabilirsiniz. Yazıyı iyi bir şekilde inceledikten sonra ekteki proje formatını doldurarak <a href="http://www.futurefoodscompetition.com/">www.futurefoodscompetition.com</a>  linkinde proje gönderimi kısmına eklemenizi bekliyoruz.</p>

                                               <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
                                               <p style="font-size: 14px; line-height: 140%;">Unutmayın; proje gönderimi için son tarih 1 Nisan!</p>
  ...
  $file_url_array_for_members = array();
  array_push($file_url_array_for_members, "../assets/website-files/FFC-PROJE-FORMATI.pdf","../assets/website-files/FFC-BRIEF.pdf");
	foreach($members as $member){

  SendEmail($member['mail'],$message_for_team_members,$subject_for_team_members,$file_url_array_for_members);
  ...
  if($team_info[0]['pre_project'] != null){
    $pre_project_file = $team_info[0]['pre_project'];
    array_push($file_url_array, $pre_project_file);
  }
                                               ...
                                               <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                  <tr>
                                                     <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                        ...
                                                        <img align="center" border="0" src="http://futurefoodscompetition.com/assets/images/logo-eg.png" alt="" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 13%;max-width: 114.4px;" width="114.4"/>
                                                        </a>
                                                     </td>
                                                  </tr>
                                               </table>
