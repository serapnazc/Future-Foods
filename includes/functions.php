...
function SendEmail($to,$message,$subject,$file_url_array=array()){
  ...
  $mail->CharSet = 'UTF-8';
  		...
  		try {
  		    ...
  		    $mail->isSMTP();
  		    $mail->Host = 'rd-rebirth.panel-giris.com';
  		    $mail->SMTPAuth = true;
  		    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
  		    $mail->Port = 587;


          $mail->Username = "info@futurefoodscompetition.com"; // SMTP username
          $mail->Password = "#n{@3W&^@M%6"; // SMTP password

  		    // Sender and recipient settings
  		    $mail->setFrom('info@futurefoodscompetition.com', 'FUTURE FOODS COMPETITION');
