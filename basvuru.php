					...
					<div id="" class="form-container">
							<form method="post" action="basvuru.php">
							    ...
							    <div class="col-md-6 pull-right">
							      <input type="text" class="form-control" name="team_name" placeholder="Takim Adi" required>
							    </div>
							  </div>

								<h4 class="apply-title">1. UYE</h4>
								<div class="col-md-6">
									<div class="form-group">
		                <input name="member_one_name" type="text" value="" placeholder="Isim Soyisim" class="form-control" required />
									</div>
									<div class="form-group">
		                <input name="member_one_phone" type="text" value="" placeholder="Email" class="form-control"  required/>
									</div>
									<div class="form-group">
		                <input name="member_one_email" type="text" value="" placeholder="Telefon" class="form-control"  required/>
									</div>
								</div>

								<div class="col-md-6">
									<div class="form-group">
										<select  name="member_one_school" class="form-control" required>
									...
									<div class="form-group">
										<select name="member_one_grade" class="form-control" required>
							        <option value="">Sinif</option>
							        <option value="1">1</option>
											<option value="2">2</option>
											<option value="3">3</option>
											<option value="4">4</option>
											<option value="5">Yuksek Lisans</option>
							      </select>
									</div>
									<div class="form-group">
										<select  name="member_one_department"class="form-control" required>
							        <option value="">Bolum</option>
							        <option value="gida">Gıda Mühendisliği</option>
											<option value="kimya">Kimya Mühendisliği</option>
											<option value="beslenme">Beslenme ve Diyetetik</option>
								...
								<div id="member-div" style="display:none;">

									<h4 class="apply-title" id="member-div">2. UYE</h4>
									<div class="col-md-6">
										<div class="form-group">
											<input name="name"  type="text" value="" placeholder="Isim Soyisim" class="form-control" />
										</div>
										<div class="form-group">
											<input name="phone" type="text" value="" placeholder="Email" class="form-control" />
										</div>
										<div class="form-group">
											<input name="mail"  type="text" value="" placeholder="Telefon" class="form-control" />
										</div>
									</div>
												...
												<option value="gastronomi">Gastronomi</option>
																																		...
																																		<div class=" col-lg-6 col-md-4 col-sm-5 col-xs-12">
																																		  <div class="select-box">
																																			<button id="add-member"  onclick="addMember();">	<i class="fa fa-plus-square"></i> </button>
																																			<label for="radio-one">
								...
								<div class="form-group">
		              <button class="btn btn-primary" type="submit"  name="apply-submit">GONDER</button>
								</div>
							</form>
...
<script>
		function addMember() {
			member= document.getElementById('member-div');
			button= document.getElementById('add-member');
			member_div = document.getElementById('member-div');
			member_div.style.display="block";
