				...
				if($result_team === true){
					...
					for($i=1; $i<($member_id+1); $i++){
						...
						if($result_members == true){
													...
													CurlRequest('localhost:8080/futurefoodsforum/api/api-send-team-emails.php','POST',$postInput);
													//curl(team_id)
						}
		...
		<div class="container">
			...
			<div class="row">
					<div id="" class="form-container">
	                      ...
	                      <label class="custom-control-label float-left" for="condition"><a class="link-a" data-toggle="modal" data-target="#kkModal">Katılım koşullarını okudum</a>, kabul ediyorum.</label>
	                  </div>
									</div>
